...
export default {
    ...
    data() {
        return {
            ...
            isPrivate: true,
            isSwapFrom: true,
            // This is incremented every time we observe an expired market so that we will fetch rates again.
            expiryNonce: 0,
    ...
    asyncComputed: {
        marketInfo: {
            default: {},
            async get() {
                // We will change expiryNonce when we observe an expired quote, which will cause marketInfo to be refreshed.
                this.expiryNonce;
