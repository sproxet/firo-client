...
export class Zcoind {
    ...
    async sendSigma(auth: string, label: string, recipient: string, amount: number, subtractFeeFromAmount: boolean,
        ...
        if (typeof data === 'string') {
            ...
            throw new UnexpectedZcoindResponse('create/sendSigma', data);
        }
    }
    ...
    async sendLelantus(auth: string, recipient: string, amount: number, subtractFeeFromAmount: boolean,
        ...
        if (typeof data === 'string') {
            ...
            throw new UnexpectedZcoindResponse('create/sendLelantus', data);
        }
    }
    ...
    async mintAllLelantus(auth: string): Promise<string[]> {
        ...
        if (typeof data !== 'object') throw new UnexpectedZcoindResponse('create/mint', data);
        for (const x in data) {
            if (typeof x !== 'string') throw new UnexpectedZcoindResponse('create/mint', data);
        }
        return <string[]>data;
    }
